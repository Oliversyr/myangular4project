 ...
 * @Last Modified time: 2018-01-15 10:54:32
 */
@Injectable()
export class DeliveryService extends TopCommon {
    constructor(
    ...
    /**
     * 配送单列表数据操作: 列表、编辑、详情页面都需要使用
     */
    operate(param): Observable<any> {
        let myParam: SuiRequest<any, any> = {
            url: 'api/storagem/delivery/operate',
            rootPath: this.globalService.getSuiLocalConfig().BUSINESS_ROOTPATH,
