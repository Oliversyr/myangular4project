...
import { OutInputListComponent } from './outInput-list.component';
...
@NgModule({
    declarations: [ OutInputListComponent ],
    imports: [ CommonModule, 
                CommonListModule,
                SuiOrganModule,
                SuiGoodsModule,
                RouterModule.forChild([
                    {path: "", component: OutInputListComponent},
                    // {path: "manageShop", component: ManageShopComponent}
                ])
            ],
    exports: [ OutInputListComponent ],
    providers: [ OutInputListService, OutInputService ],
    schemas: [ NO_ERRORS_SCHEMA ]
})

export class OutInputModule { }