...
@Component({
    ...
    styleUrls: ['./transfer-list.scss']
})
export class TransferListComponent extends BaseListComponent implements OnInit {
    /** template-list配置参数 */
    ...
    constructor(
        ...
        public myService: TransferListService
    ) {
        super();
    }
    ...
    private initGridColumns() {
        ...
        let columndef = [
            ...
            { "text": "调出仓库", "datafield": "outstockname", "align": "center", "width": 220, pinned: true },
            { "text": "调入仓库", "datafield": "instockname", "align": "center", "width": 220, pinned: true },
            {
