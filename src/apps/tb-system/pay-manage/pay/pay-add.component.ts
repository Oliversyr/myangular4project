 ...
 * @Last Modified time: 2018-01-25 14:58:29
 */

@Component({
    selector: 'pay-add',
    templateUrl: './pay-add.html',
    styleUrls: ['./pay-add.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PayAddComponent extends TopCommon implements OnInit {
    /** 热键 */
    hotkeys: any = HOTKEYS;
    /** 调出仓库 */
    outstockid?: number;
