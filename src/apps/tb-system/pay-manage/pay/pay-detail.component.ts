...
import { TransferInfo } from './pay-edit.component';
import { TansferDirection } from './pay-list.component';
 ...
 * @Last Modified time: 2018-01-25 14:56:41
 */
@Component({
    templateUrl: './pay-detail.html',
    styleUrls: ['./pay-detail.scss']
})
export class PayDetailComponent extends BaseDetailComponent implements OnInit {
    /** template-edit配置参数 */
    ...
    constructor(
        ...
        private myService: PayDetailService
    ) {
        super();
    }
