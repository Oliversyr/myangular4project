 ...
 * @Last Modified time: 2018-01-26 20:31:57
 */
import { NgModule, Component, ElementRef, Injectable, Inject, NO_ERRORS_SCHEMA, ViewChild, TemplateRef, Input, Output } from '@angular/core';
import { OnChanges, SimpleChanges, OnInit, AfterViewInit, OnDestroy } from '@angular/core';
...
export class RechargeListComponent extends BaseListComponent implements OnInit, AfterViewInit {
    ...
    // 客户
    @ViewChild('suiClient') suiClient: Modal;
    ...
    doReset() {
        ...
        // let res = this.suiClient && this.suiClient.clearSelection();
    }
     ...
     * 审核 删除 提交数据
     */
    private doOperate(param: any, title: string){
