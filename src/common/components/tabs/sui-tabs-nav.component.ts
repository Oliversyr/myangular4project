      ...
      <div class="ant-tabs-nav-wrap">
        <div class="ant-tabs-nav-scroll">
          <div class="ant-tabs-nav" [class.ant-tabs-nav-animated]="nzAnimated" #tabList (cdkObserveContent)="_onContentChanges()">
            <div sui-tabs-ink-bar [hidden]="nzHideBar" [nzAnimated]="nzAnimated" [nzPositionMode]="nzPositionMode" style="display: block;"></div>
...
export class SuiTabsNavComponent implements AfterContentChecked, AfterContentInit {
  ...
  @ContentChildren(SuiTabLabelDirective) _labelWrappers: QueryList<SuiTabLabelDirective>;
  @ViewChild(SuiTabsInkBarDirective) _inkBar: SuiTabsInkBarDirective;
