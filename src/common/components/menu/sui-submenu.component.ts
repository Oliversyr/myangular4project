...
@Component({
  ...
  `,
}) export class SuiSubMenuComponent implements OnInit, OnDestroy, AfterViewInit {
  isInDropDown = false;
  level = 1;
  _$mouseSubject = new Subject();
  @ContentChildren(SuiSubMenuComponent) subMenus;
  @Input() nzOpen = false;
  ...
  constructor(public nzMenuComponent: SuiMenuComponent, public cd: ChangeDetectorRef) {
