...
import { SuiMenuComponent } from './sui-menu.component';
import { SuiSubMenuComponent } from './sui-submenu.component';
...
export class SuiMenuItemComponent implements AfterViewInit {
  level = 0;
  padding = null;
  isInDropDown = false;
  selected = false;
  ...
  constructor(private _renderer: Renderer2, public cd: ChangeDetectorRef, private nzMenuComponent: SuiMenuComponent, @Optional() public nzSubMenuComponent: SuiSubMenuComponent, private hostElement: ElementRef) {
