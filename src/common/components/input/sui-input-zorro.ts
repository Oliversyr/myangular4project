...
//   d:\ydxl\angular4\slic-main\node_modules\ng-zorro-antd\src\util\calculate-node-height.d.ts
    ...
    providers    : [
      {
        ...
        useExisting: forwardRef(() => SuiInputZorro),
        multi      : true
      }
    ],
    styleUrls    : [
  ...
  export class SuiInputZorro implements AfterContentInit, ControlValueAccessor, AfterViewInit {
...
export class SuiInputZorroModule { }