...
export class SuiColComponent implements OnInit, OnChanges {
  ...
  constructor(private _elementRef: ElementRef, @Optional() @Host() public _nzRow: SuiRowComponent, private _renderer: Renderer2) {
