import {
  ...
  ElementRef,
  ViewEncapsulation,
  Renderer2,QueryList,ContentChildren,AfterViewInit,AfterContentInit
} from '@angular/core';
import { RulesDirective } from '../validator/sui-rules.directive';
...
export class SuiRowComponent implements OnInit,AfterViewInit,AfterContentInit {

  @ContentChildren(RulesDirective) childrenRules: QueryList<RulesDirective>;
