  ...
  providers    : [
    {
      ...
      useExisting: forwardRef(() => SuiCheckboxGroupComponent),
      multi      : true
    }
  ],
  styleUrls    : [
...
export class SuiCheckboxGroupComponent implements OnInit, AfterContentInit, ControlValueAccessor {
  _el: HTMLElement;
  _options: Array<any>;
